...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget = new QWidget(pageUser);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(60, 50, 161, 65));
        gridLayout = new QGridLayout(layoutWidget);
        gridLayout->setObjectName("gridLayout");
        gridLayout->setContentsMargins(0, 0, 0, 0);
        userId = new QLabel(layoutWidget);
        userId->setObjectName("userId");

        gridLayout->addWidget(userId, 0, 0, 1, 1);

        userIdInput = new QLineEdit(layoutWidget);
        ...
        layoutWidget1 = new QWidget(pagePay);
        layoutWidget1->setObjectName("layoutWidget1");
        layoutWidget1->setGeometry(QRect(50, 40, 205, 66));
        gridLayout_2 = new QGridLayout(layoutWidget1);
        gridLayout_2->setObjectName("gridLayout_2");
        gridLayout_2->setContentsMargins(0, 0, 0, 0);
        recipientId = new QLabel(layoutWidget1);
        recipientId->setObjectName("recipientId");

        gridLayout_2->addWidget(recipientId, 0, 0, 1, 1);

        recipientIdInput = new QLineEdit(layoutWidget1);
        ...
        amountInput = new QSpinBox(layoutWidget1);
        ...
        layoutWidget2 = new QWidget(pageOtp);
        layoutWidget2->setObjectName("layoutWidget2");
        layoutWidget2->setGeometry(QRect(51, 40, 174, 66));
        gridLayout_3 = new QGridLayout(layoutWidget2);
        gridLayout_3->setObjectName("gridLayout_3");
        gridLayout_3->setContentsMargins(0, 0, 0, 0);
        otp = new QLabel(layoutWidget2);
        otp->setObjectName("otp");

        gridLayout_3->addWidget(otp, 0, 0, 1, 1);

        otpValue = new QLineEdit(layoutWidget2);
        otpValue->setObjectName("otpValue");

        gridLayout_3->addWidget(otpValue, 0, 1, 1, 1);

        getOtp = new QPushButton(layoutWidget2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        getOtp->setText(QCoreApplication::translate("MainWindow", "Resend OTP", nullptr));
